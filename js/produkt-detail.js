document.addEventListener('DOMContentLoaded', async function() {
    ...
    const productDatabase = {
        ...
        '5w30-premium-longlife': {
            ...
            approvals: ['MB 229.52'],
            specifications: ['API SP', 'ACEA C3', 'VW 504.00/507.00', 'BMW Longlife 04', 'MB 229.51'],
            applications: [
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <div class="mb-6">
                        ...
                        <h3 class="font-bold text-lg mb-3">Freigaben</h3>
                        <div class="flex flex-wrap gap-2 mb-4">
                            ${product.approvals.map(approval => 
                                `<span class="text-xs bg-green-100 text-green-800 px-2 py-1 rounded font-semibold">${approval}</span>`
                            ).join('')}
                        </div>
                        ` : ''}
                        <h3 class="font-bold text-lg mb-3">Spezifikationen & Empfehlungen</h3>
